...
const PUBLISHED_JSON = path.join(__dirname, 'published-desc.json');
const STUBS_JSON = path.join(__dirname, 'stubs-desc.json');
const VOLUNTEERING_JSON = path.join(__dirname, 'volunteering-desc.json');
    ...
    try {
        ...
        for (const rec of publishedRecords) {
            ...
            const fieldsToRemove = [
                ...
                "ContactEmailAddressOrWebpage", "Approved",
                "Placeholder", "Tags", "Region", "HostOrg", 
                "HostVolunteeringIndividualUrl", 
                "ProjectVolunteeringIndividualUrl", "Published", "Description",
